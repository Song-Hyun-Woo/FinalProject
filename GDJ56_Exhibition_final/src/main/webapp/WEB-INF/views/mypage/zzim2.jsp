...
<style>
        ...
        <div class="zzim-container">
            ...
            <c:choose>
                <c:when test="${count==0}">
                    ...
                    <br>
                    <br>
                    <button type="button" class="btn btn-dark" name="exhibitionMove">찜 하러가기</button>
                </c:when>
                <c:otherwise>
                    ...
                    <hr>
                    <form action="${path }/member/mypage/zzimInsert" onsubmit="return zzimMoved()"id="zzimMoved">
                                ...
                                <tbody>
                                    <tr class="payment-tr">
                                        <td style="width: 20%;">
                                            ...
                                            <input type="hidden" name="" value="${z.}">
                                            <input type="hidden" name="" value="${z.}">
                                            <input type="hidden" name="ex_Price" value="${z.product.productPrice}">
                                            ...
                                            style="text-decoration: none;"> <img
                                                src="${z.exhibition. }" width="150" height="150"
                                                 style="margin-left: 10" />
                                            </a></td>
                                        <td style="width: 55%"><a
                                            href="${path}/exhList" class="proName"><c:out
                                                    value="${z. }" /></a><br>
                                        <br>
                                            <div style="margin-top: 5;">
                                                <c:out value="${z.exPrice }원" />
                                            </div></td>
    ...
    $("button[name= exhibitionMove]").click(function(){
          location.assign("${path}/exhList");
    })
