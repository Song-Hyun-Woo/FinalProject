  ...
  <body>
	...
	<div class="input-form col-md-12 mx-auto">
	  ...
	  <span class="guide error">이 아이디는 사용 불가능 합니다.</span>
        ...
        <p class="text">비밀번호 재확인</p>
        <input type="password"  id="password2" class="form-control" placeholder="비밀번호 재확인 " required><br>
       ...
       <div id="contents"> 
        ...
        <br/>
          <button type="submit" id="btn-Yes" class="btn btn-lg btn-dark btn-block">회원가입</button>
        <br>
        <br>
    </form>
  ...
  /* 모든 공백 체크 정규식 */
	  ...
	  //비밀번호 중복확인
	   ...
	   $("#birth").blur((e)=>{
		  ...
		  if(dateStr.length <=8){
			  //년도가 1900보다 작거나 년도가 2023년도을 넘으면 false
