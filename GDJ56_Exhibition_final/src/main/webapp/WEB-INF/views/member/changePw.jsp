	...
	<body>
	    <div class="findpw">
	            <div class="account-login">
                    ...
                    <p style="font-size:35px; margin-top:44px; margin-bottom:31px; font-weight:bold;">새 비밀번호 변경</p><p></p>
                    <span style="margin-top:31px;">새로운 비밀번호를 입력해주세요.</span></p>
	                  ...
	                  <div class="rememberfind">
	                     <button id="btn-Yes"  type="submit" class="btn btn-lg btn-dark btn-block">비밀번호변경</button>
	                   </div>
	                   <div class="links"> 
